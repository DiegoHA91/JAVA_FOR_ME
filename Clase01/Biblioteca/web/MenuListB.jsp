...
<html>
	...
	<body>
		<div id="header">
                ...
                <div id="regbib">
                <h3>Listado  de Bibliotecarios</h3>
                    ...
                    <table class="table table-bordered table-hover table-striped table-condensed" aling="center" width="610px"> 
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td ><h4><img src="img/admin.jpg" width="20" height="20"><%= y[2].toString()%></h4></td>
                            </tr>
                        </tbody>
                        <%}%>
