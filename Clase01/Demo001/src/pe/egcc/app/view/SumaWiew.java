 ...
 * @author Alumno
 */
public class SumaWiew extends javax.swing.JFrame {

    /**
     * Creates new form SumaWiew
     */
    public SumaWiew() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SumaWiew.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
